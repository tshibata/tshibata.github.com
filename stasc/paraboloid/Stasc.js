...
Screen=function(){
	...
	n13.setAttribute('style','fill:none; stroke:black; stroke-width:1px;');
	...
	n14.setAttribute('dur','3s');
	n14.setAttribute('from','16px');
	n14.setAttribute('to','0px');
	n13.appendChild(n14);
	...
	n15.setAttribute('style','fill:none; stroke:black; stroke-width:1px;');
	...
	n16.setAttribute('dur','3.5s');
	n16.setAttribute('from','8px');
	n16.setAttribute('to','0px');
	n15.appendChild(n16);
	...
	n18.setAttribute('from','6px');
	n18.setAttribute('to','0px');
	n17.appendChild(n18);
	n17.appendChild(document.createTextNode('(https://github.com/tshibata/stasc)'));
	n11.appendChild(n17);
	var n19=document.createElementNS('http://www.w3.org/2000/svg','text');
	n19.setAttribute('x','160');
	n19.setAttribute('y','280');
	n19.setAttribute('text-anchor','middle');
	n19.setAttribute('font-family','Helvetica');
	n19.setAttribute('font-size','48');
	n19.setAttribute('style','fill:none; stroke:crimson; stroke-width:1px;');
	...
	n20.setAttribute('dur','4s');
	n20.setAttribute('from','16px');
	n20.setAttribute('to','0px');
	n19.appendChild(n20);
	n19.appendChild(document.createTextNode('stasc'));
	n11.appendChild(n19);
	n9.appendChild(n11);
